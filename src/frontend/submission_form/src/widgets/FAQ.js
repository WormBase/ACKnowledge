        ...
        <div>
            ...
            <ol>
                ...
                <li><FAQsingle question={"How do I add missing entities?"}
                               answer={"To add missing entities, click on the 'Add' buttons in each respective entity box. A new box will appear. Here you can start typing in the entity name and the list will auto populate on existing WormBase entities. If the entity you are looking for does not appear, make sure you are typing it in correctly. If it is still not there, it means that the entity is not yet in the Alliance and needs to be added (see below)."}/></li>
                <li><FAQsingle question={"How do I submit new entities?"}
                               answer={"<strong>Genes</strong>: To request a 'New Gene Name' click on the 'Can't find a gene? Request new gene name' in the 'Genes' section of the Overview (genes and species) widget. Once the text expands, click on '<a target='_blank' href='https://www.wormbase.org/submissions/gene_name.cgi'>Request new gene name or report gene-sequence connections</a>' to submit a request to the nomenclature committee.<br/><br/>" +
                               "<strong>Species</strong>: You can enter species not yet in our system by clicking on 'Can't find a species? Add new species not yet in WormBase' in the 'Species' section of the Overview (genes and species) widget. Enter one species per line.<br/><br/>" +
                               "<strong>Alleles</strong>: You can enter new alleles by clicking on 'Can't find an allele? Add new alleles not yet in WormBase' in the 'Alleles' section of the Genetics widget. Enter one allele per line.<br/><br/>" +
                               "<strong>Strains</strong>: You can enter new strains by clicking on 'Can't find a strain? Add new strains not yet in WormBase' in the 'Strains' section of the Genetics widget. Enter one strain per line.<br/><br/>" +
                               "<strong>Transgenes</strong>: You can enter new Transgenes by clicking on 'Can't find a transgene? Add new transgenes not yet in WormBase' in the 'Transgenes' section of the Reagents widget. Enter one Transgene per line.<br/><br/>" +
                               "<strong>Antibodies</strong>: You can enter information about new antibodies in the 'Antibodies in the paper' section of the Reagents widget. Click the 'Newly generated antibodies' checkbox, then enter the antibody details in the text box that appears below."}/></li>
                ...
                <li><FAQsingle question={"How do I view selected entities in WormBase?"}
                               answer={"To view selected entities in the identified entity lists click on the entities you want to view and then click on the 'View in WB' link at the top right of the entity box. Note that some browsers, e.g. Chrome, will require that you allow pop-ups from 'https://acknowledge.textpressolab.com' to open a new WormBase tab."}/></li>
            </ol>
            ...
            <ol>
                ...
                <li><FAQsingle question={"Can I submit other types of data not listed in the ACKnowledge form?"}
                               answer={"If your paper includes data types not listed in the ACKnowledge form, please let us know by adding a note in the 'Please give us your feedback' field in the 'Comments and submit' widget."}/></li>
            </ol>
            ...
            <ol>
                <li><FAQsingle question={"Can I make changes to my ACKnowledge entries after submission of the form?"}
                               answer={"Yes, you can update your submission at any time. Just click on the link to the form in the original email message we sent and modify your entries, as needed.<br/><br/>You must still click on the 'Save and go to next section' button at the bottom of each updated page, and also click on the 'Finish and Submit' button on the final 'Comments and submit' widget to submit your updates.<br/><br/>If you no longer have the original ACKnowledge email, please go to the <a target='_blank' href='https://acp.acknowledge.textpressolab.com/'>Author Curation Portal page</a> or <a target='_blank' href='mailto:help.acknowledge@wormbase.org'>contact us</a>."}/></li>
            </ol>
            ...
            <ol>
                <li><FAQsingle question={"What happens to the non-C. elegans data in my paper?"}
                               answer={"Currently, we prioritize curation of C. elegans data. If you have questions about curation of data for other species, please <a target='_blank' href='mailto:help.acknowledge@wormbase.org'>contact us</a>."}/></li>
            </ol>
        </div>
    );
}
