        ...
        <div>
            ...
            <ol>
                ...
                <li><FAQsingle question={"How do I view multiple selected entities in WormBase?"}
                               answer={"To view multiple selected entities in the identified entity lists click on the entities you want to view and then click on the ‘Show selected in WB’ link at the bottom of the entity box. Note that some browsers, e.g. Chrome, will require that you allow pop-ups from 'https://afp.textpressolab.com' to open more than one WormBase tab. To allow pop-ups in Chrome, select Preferences from the Chrome menu, navigate to the Privacy and Security widget, and then select Site settings from the Privacy and security section. Scroll to the bottom of the list and under the Content heading select Pop-ups and  redirects.  Navigate to Allowed to send pop-ups and use redirects, click on Add, and add 'https://afp.textpressolab.com'."}/></li>
            </ol>
