    ...
    render() {
        return (
            <div>
                ...
                <ol>
                    <li><FAQsingle question={"General Information on Author First Pass and Community Curation"}
                    ...
                    <li><FAQsingle question={"How is my curation acknowledged in WB?"}
                                   answer={"We will soon be acknowledging authors who contribute to Author First Pass on the relevant WormBase paper pages."}/></li>
                ...
                <ol>
                    <li><FAQsingle question={"Can someone other than the original recipient of the Author First Pass email submit the form?"}
                                   answer={"The Author First Pass (AFP) form can be filled out by anyone in your lab. You can forward the email containing the link you receive. The new submitter then just needs to change the submitter name by clicking on ‘Change User’ on the Overview widget and by typing a name in the pop-up window. Remember: you need to be a registered WormBase person to see your name on the list. If you don’t have a WBPerson ID, you can request one <a target='_blank' href='https://wormbase.org/submissions/person.cgi'>here</a>."}/></li>
                ...
                <ol>
                    <li><FAQsingle question={"What types of entities are included in the Author First Pass form?"}
                                   answer={"WormBase collects different types of entities, such as genes, species, alleles, strains, and transgenes. We link these entities to individual publications so they  can be searched on <a target='_blank' href='https://www.wormbase.org'>www.wormbase.org</a>. By validating the entities that we extracted, you are helping us to make the right entity-paper connections thus providing useful information to WormBase users."}/></li>
                    <li><FAQsingle question={"Which entities should I submit?"}
                                   answer={"WormBase curates entities that are experimentally studied in the paper. For example, if your paper describes the biological function of a specific gene, you should submit that gene with the paper. Genes that are used as ‘Reagents’, e.g. tissue specific promoters, expression or genetic markers, are not typically associated with papers where they are used.<br/>Our text-mining approaches are good but not perfect; that is why we need your help! We might miss entities or we might include entities that should not be included -as the “reagent” examples above. In both cases you can help us improve our lists by adding what we have missed or removing what we have erroneously extracted. <ol type='i'><li>In doubt?  Refer to <span class=\"glyphicon glyphicon-question-sign\"></span> marks on the form<br/>Each section has <span class=\"glyphicon glyphicon-question-sign\"></span> pop-ups that have more information. If you have suggestions on how we can improve the text in the pop-ups do not hesitate to <a href='mailto:help.afp@wormbase.org'>contact us</a>.)</li></ol>"}/></li>
                    <li><FAQsingle question={"How are the pre-populated entity lists generated?"}
                                   answer={"We use text mining approaches, and other methods, to pre-populate the lists. For instance, genes and alleles are identified using <a target='_blank' href='https://en.wikipedia.org/wiki/Tf–idf'>TFIDF</a> (term frequency–inverse document frequency, a numerical statistic). Species, strains, and transgenes are identified using empirically determined thresholds. The method used is based on our analysis for what provides the most accurate entity list."}/></li>
                    <li><FAQsingle question={"How do I add missing entities?"}
                                   answer={"To add missing entities, click on the ‘Add from WB list’ blue button. A pop up window will appear. Here you can start typing in the entity name and the list will auto populate on existing WormBase entities. If the entity  you are looking for does not appear, make sure you are typing it in correctly. If it is still not there, it means that the entity is not yet in WormBase and needs to be added -see below."}/></li>
                    <li><FAQsingle question={"How do I submit new entities?"}
                                   answer={"<ol type='a'><li><strong>Genes</strong>: To request a ‘New Gene Name’ click on the ‘Request new gene name’ button in the AFP form. This will bring you to a separate form that will be submitted to the nomenclature committee. The link to the ‘New Gene Name’ form is also <a target='_blank' href='https://wormbase.org//submissions/gene_name.cgi'>here</a>." +
                                   "<li><strong>Alleles</strong>: You can enter new alleles in the ‘New Alleles’ box in the AFP form. Enter one allele per line.</li>" +
                                   "<li><strong>Strains</strong>: You can enter new strains in the ‘New Strains’ box in the AFP form. Enter one strain per line.</li>" +
                                   "<li><strong>Transgenes</strong>: You can enter new Transgenes in the ‘New Transgenes’ box in the AFP form. Enter one Transgene per line.</li>" +
                                   "<li><strong>Antibodies</strong>: You can enter information on newly generated antibodies in the section ‘Antibodies in the paper’ in the AFP form.</li>"}/></li>
                    ...
                    <li><FAQsingle question={"How do I submit large entity (e.g. genes, alleles, strains) lists?"}
                                   answer={"Our submission form displays lists of up to 100 entities, but if your paper refers to more than 100 entities, you can submit the full list by <a href='mailto:help.afp@wormbase.org'>contacting us</a>."}/></li>
                ...
                <ol>
                    <li><FAQsingle question={"How are the different data types identified?"}
                                   answer={"Wherever possible, we use machine learning to help automate identification of different data types, e.g. anatomical expression patterns, RNAi phenotypes, and genetic interactions.  Automatically identified data types are indicated on the form with the <img src=\"tpc_powered.svg\" width=\"80px\"/> tag.  More information about this work can be found in the <a href='#reference'>reference section</a>."}/></li>
